...
Halaman ini berfungsi sebagai pusat informasi, navigasi, dan aktivitas harian.

Di dalam Beranda Lansia terdapat dua fitur utama berikut:
...
Fitur latihan otak harian yang bertujuan menjaga daya ingat dan konsentrasi lansia, berupa:
- Puzzle interaktif
- Kuis ringan
...
Halaman **Layanan Lansia** berfokus pada proses pemesanan sesi pendampingan dengan relawan secara mandiri.

Alur layanan meliputi:
1. Pemilihan jenis layanan (**Chat**, **Voice Call**, atau **Video Call**)
2. Pemilihan relawan pendamping
3. Pemilihan tanggal dan waktu sesi
4. Konfirmasi pemesanan layanan

Fitur ini dirancang untuk memastikan pendampingan emosional yang terjadwal dan terstruktur.
...
### 🧑‍🤝‍🧑 Relawan (Volunteer)
Relawan berperan sebagai pendamping emosional bagi lansia.
